		...
		<table style="text-align: left; width: 973px; height: 435px;"
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3" rowspan="1"
						style="vertical-align: top; height: 20px; width: 163px; text-align: right;">
						<security:authorize access="isAnonymous()">
						To view plans, please <a
						...
						<form name="planDetailsForm" method="post", action="planDetails">
							<table
								...
								<tbody>
									...
									<c:forEach var="planInfo" items="${planInfos}">
										<tr name="selectedRow"
