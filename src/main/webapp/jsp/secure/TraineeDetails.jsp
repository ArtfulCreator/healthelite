			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3" rowspan="1"
						style="vertical-align: top; height: 20px; width: 163px; text-align:left;">${traineeInfo.roles.login.getFirstName()} !<br>
					</td>
						...
						<div id="tabContainer">
							<div class="tabs">
											<ul style="list-style:none outside none;" >
												<li id="tabHeader_1" value="${plansTab}">Plans</li>
												<li id="tabHeader_2" value="${scheduleTab}">Schedule</li>
								...
								<tr>
									<td>
										...
										<div class="tabscontent">
											<div class="tabpage" id="tabpage_1"><jsp:include page="ManagePlans.jsp"/></div>
											<div class="tabpage" id="tabpage_2"><jsp:include page="ManageSchedule.jsp"/></div>
